...
New_DB<-cbind(DB_reduced[,Variables_supp],DB_reduced$freqtcu,DB_reduced$permis,DB_reduced$tailmng,DB_reduced$car_ownership) #création de la nouvelles bases de données 

New_DB<-rename(New_DB,"freqtcu"="DB_reduced$freqtcu")
New_DB<-rename(New_DB,"permis"="DB_reduced$permis")
New_DB<-rename(New_DB,"tailmng"="DB_reduced$tailmng")
New_DB<-rename(New_DB,"car_ownership"="DB_reduced$car_ownership")
...
#New_DB$sexew-replace(New_DB$sexe,New_DB$sexe==1,"Homme")
#New_DB$sexew-replace(New_DB$sexe,New_DB$sexe==2,"Femme")
