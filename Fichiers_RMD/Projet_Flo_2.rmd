...
model_glm_test_2 =glm(formula = freqtcu ~ tailmng + Comfort_social, data = train_2, family = "binomial")
...
naiv_1 = naiveBayes(freqtcu ~ tailmng+permis+Comfort_social, data = train_B)
